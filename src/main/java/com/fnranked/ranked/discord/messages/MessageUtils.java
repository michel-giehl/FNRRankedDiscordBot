...
import static com.fnranked.ranked.data.MatchVote.PENDING;
...
public class MessageUtils {
    ...
    public void sendMatchReadyMessage(MatchTemp matchTemp) {
        ...
        readyEmbed.setDescription("Your match is ready. Click [here](" + matchTemp.getMatchServer().getInviteUrl() + ") to get to your match channel");
    }
